...
class RectPrism : public ConvexObj {
 ...
 private:
  ...
  Rotation _rotation;  //!< Rotation from local coordinate frame to global coordinate frame
  Rotation _rotationInv;  //!< Rotation from global coordinate frame to local coordinate frame
